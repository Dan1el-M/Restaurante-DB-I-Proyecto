"""Assign delivery orders to drivers using a nearest-neighbor heuristic."""
...
def assign_routes(max_hops: int, clean: bool) -> int:
    ...
    with driver:
        ...
        with driver.session(database=database) as session:
            ...
            print("[OK] Repartidores disponibles:", len(drivers))
            print("[OK] Pedidos a asignar:", len(orders))
            unassigned = orders[:]
